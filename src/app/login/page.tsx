...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Dans une application réelle, ceci appellerait une API d'authentification
      // Pour la démo, simuler une connexion réussie après un délai
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <br />
            Mot de passe: <span className="font-medium">password</span>
          </p>
        </div>
      </div>
    </div>
